...
const String AUTHORIZED_CARD_UIDs[] = {"93 26 71 17"};
...
void handleData() {
    float solarCurrent = (analogRead(32) * 5.0) / 10023.0;
    float solarVoltage = (analogRead(34) * 2.5) / 1023.0;
    ...
    json += "\"solarWatt\":" + String(solarWatt, 2) + "}";
